...
export function Presenter() {
  return (
    <main className="flex flex-col items-center bg-background-game md:p-8 rounded-xl shadow-md shadow-black p-6">
      <p className="font-poppins font-extrabold md:text-xl p-6 text-center lg:max-w-md text-lg">
