...
export default function Home() {
  return (
    <main className="flex flex-col items-center min-h-screen min-w-screen overflow-hidden">
      <div className="mt-10">
        <LogoQueston />
      </div>
      ...
      <div className="font-poppins flex flex-col items-center w-full lg:max-w-md space-y-4 mt-2">
